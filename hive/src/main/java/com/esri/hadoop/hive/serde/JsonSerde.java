                    ...
                    if ("geometry".equals(parser.getCurrentName())) {
                        if (geometryColumn > -1) {
                            ...
                            row.set(
                                    ...
                                    mapGeom == null ?
                                            null :
                                            GeometryUtils.geometryToEsriShapeBytesWritable(OGCGeometry.createFromEsriGeometry(mapGeom.getGeometry(), mapGeom.getSpatialReference()))
                            );
                        } else {
                            // no geometry in select field set, don't even bother parsing
                            parser.skipChildren();
                        }
                    } else if ("attributes".equals(parser.getCurrentName())) {
        ...
        try {
            ...
            if (geometryColumn > -1) {
                ...
                if (bytesWritable == null) {
                    ...
                    jsonGen.writeRaw(",\"geometry\":" + GeometryEngine.geometryToJson(ogcGeometry.getEsriSpatialReference(), ogcGeometry.getEsriGeometry()));
                }
            }
